...
Before this point, the penalty can outweigh its benefit for Vital Strike specifically.
However; this does not take into account the Focused Strike feat, with it there's no downside to taking both as early as one can.

??? feat "Power Attack"
    {% include '_includes/power_attack.md' %}
...
??? feat "Focused Strike"
    {% include '_includes/focused_strike.md' %}

The **Cleave** line has already been discussed in [exploits](#cleaving-finish).

??? feat "Cleave"
    {% include '_includes/cleave.md' %}

??? feat "Great Cleave"
    {% include '_includes/great_cleave.md' %}
    
??? feat "Cleaving Finish"
    {% include '_includes/cleaving_finish.md' %}

??? feat "Improved Cleaving Finish"
    {% include '_includes/improved_cleaving_finish.md' %}
...
??? feat "Deadly Aim"
    {% include '_includes/deadly_aim.md' %}
...
??? feat "Snap Shot"
    {% include '_includes/snap_shot.md' %}

??? feat "Improved Snap Shot"
    {% include '_includes/improved_snap_shot.md' %}

??? feat "Greater Snap Shot"
    {% include '_includes/greater_snap_shot.md' %}
